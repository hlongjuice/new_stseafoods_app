...
export class ProductionProductService {
    ...
    //Get All
    getAll() {
        let getUrl = this.url + '/api/production/extension/product/get_all'
    ...
    addRecord(formInputs): Promise<any> {
        ...
        let addUrl = this.url + '/api/production/extension/product/add_record';
        return new Promise((resolve, reject) => {
    ...
    updateRecord(formInputs) {
        let updateUrl = this.url + '/api/production/extension/product/update_record';
        return new Promise((resolve, reject) => {
    ...
    deleteRecord(id): Promise<any> {
        let deleteUrl = this.url + '/api/production/extension/product/delete_record/' + id;
        return new Promise((resolve, reject) => {
