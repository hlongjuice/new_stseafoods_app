...
@Injectable()
export class EngHighTankService {
    ...
    getRecordByDate(date){
        let getUrl=this.url+'/api/eng/high_tank/get_record_by_date/'+date
    ...
    addRecord(formInputs): Promise<any> {
        ...
        let addUrl = this.url + '/api/eng/high_tank/add_record';
        return new Promise((resolve, reject) => {
    ...
    updateRecord(formInputs) {
        let updateUrl = this.url + '/api/eng/high_tank/update_record';
        return new Promise((resolve, reject) => {
    ...
    deleteRecord(id):Promise<any>{
        let deleteUrl=this.url+'/api/eng/high_tank/delete_record/'+id;
        return new Promise((resolve,reject)=>{
