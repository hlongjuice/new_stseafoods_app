...
@Injectable()
export class EngIceMakerService {
    ...
    getRecordByDate(date){
        let getUrl=this.url+'/api/eng/ice_maker/get_record_by_date/'+date
    ...
    addRecord(formInputs): Promise<any> {
        ...
        let addUrl = this.url + '/api/eng/ice_maker/add_record';
        return new Promise((resolve, reject) => {
    ...
    updateRecord(formInputs) {
        let updateUrl = this.url + '/api/eng/ice_maker/update_record';
        return new Promise((resolve, reject) => {
    ...
    deleteRecord(id):Promise<any>{
        let deleteUrl=this.url+'/api/eng/ice_maker/delete_record/'+id;
        return new Promise((resolve,reject)=>{
