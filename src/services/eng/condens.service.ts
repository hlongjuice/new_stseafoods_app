...
@Injectable()
export class EngCondensService {
    ...
    getRecordByDate(date){
        let getUrl=this.url+'/api/eng/condens/get_record_by_date/'+date
    ...
    addRecord(formInputs): Promise<any> {
        ...
        let addUrl = this.url + '/api/eng/condens/add_record';
        return new Promise((resolve, reject) => {
    ...
    updateRecord(formInputs) {
        let updateUrl = this.url + '/api/eng/condens/update_record';
        return new Promise((resolve, reject) => {
    ...
    deleteRecord(id):Promise<any>{
        let deleteUrl=this.url+'/api/eng/condens/delete_record/'+id;
        return new Promise((resolve,reject)=>{
