...
@Injectable()
export class EngWaterMeterService {
    ...
    getRecordByDate(date){
        let getUrl=this.url+'/api/eng/water_meter/get_record_by_date/'+date
    ...
    addRecord(formInputs): Promise<any> {
        ...
        let addUrl = this.url + '/api/eng/water_meter/add_record';
        return new Promise((resolve, reject) => {
    ...
    updateRecord(formInputs) {
        let updateUrl = this.url + '/api/eng/water_meter/update_record';
        return new Promise((resolve, reject) => {
    ...
    deleteRecord(id):Promise<any>{
        let deleteUrl=this.url+'/api/eng/water_meter/delete_record/'+id;
        return new Promise((resolve,reject)=>{
