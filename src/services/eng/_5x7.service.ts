...
export class Eng_5x7Service {
    ...
    getRecordByDate(date){
        let getUrl=this.url+'/api/eng/_5x7/get_record_by_date/'+date
    ...
    addRecord(formInputs): Promise<any> {
        ...
        let addUrl = this.url + '/api/eng/_5x7/add_record';
        return new Promise((resolve, reject) => {
    ...
    updateRecord(formInputs) {
        let updateUrl = this.url + '/api/eng/_5x7/update_record';
        return new Promise((resolve, reject) => {
    ...
    deleteRecord(id):Promise<any>{
        let deleteUrl=this.url+'/api/eng/_5x7/delete_record/'+id;
        return new Promise((resolve,reject)=>{
