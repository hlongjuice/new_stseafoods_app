...
@Injectable()
export class EngChlorineLabService {
    ...
    getRecordByDate(date){
        let getUrl=this.url+'/api/eng/chlorine_lab/get_record_by_date/'+date
    ...
    addRecord(formInputs): Promise<any> {
        ...
        let addUrl = this.url + '/api/eng/chlorine_lab/add_record';
        return new Promise((resolve, reject) => {
    ...
    updateRecord(formInputs) {
        let updateUrl = this.url + '/api/eng/chlorine_lab/update_record';
        return new Promise((resolve, reject) => {
    ...
    deleteRecord(id):Promise<any>{
        let deleteUrl=this.url+'/api/eng/chlorine_lab/delete_record/'+id;
        return new Promise((resolve,reject)=>{
