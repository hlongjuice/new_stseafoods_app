...
@Injectable()
export class EngColdStorageService {
    ...
    getRecordByDate(date){
        let getUrl=this.url+'/api/eng/cold_storage/get_record_by_date/'+date
    ...
    addRecord(formInputs): Promise<any> {
        ...
        let addUrl = this.url + '/api/eng/cold_storage/add_record';
        return new Promise((resolve, reject) => {
    ...
    updateRecord(formInputs) {
        let updateUrl = this.url + '/api/eng/cold_storage/update_record';
        return new Promise((resolve, reject) => {
    ...
    deleteRecord(id):Promise<any>{
        let deleteUrl=this.url+'/api/eng/cold_storage/delete_record/'+id;
        return new Promise((resolve,reject)=>{
