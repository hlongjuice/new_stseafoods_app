...
@Injectable()
export class EngWaterFiltrationService {
    ...
    getRecordByDate(date){
        let getUrl=this.url+'/api/eng/water_filtration/get_record_by_date/'+date
    ...
    addRecord(formInputs): Promise<any> {
        ...
        let addUrl = this.url + '/api/eng/water_filtration/add_record';
        return new Promise((resolve, reject) => {
    ...
    updateRecord(formInputs) {
        let updateUrl = this.url + '/api/eng/water_filtration/update_record';
        return new Promise((resolve, reject) => {
    ...
    deleteRecord(id):Promise<any>{
        let deleteUrl=this.url+'/api/eng/water_filtration/delete_record/'+id;
        return new Promise((resolve,reject)=>{
