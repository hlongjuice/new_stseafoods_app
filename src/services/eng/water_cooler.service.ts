...
@Injectable()
export class EngWaterCoolerService {
    ...
    getRecordByDate(date){
        let getUrl=this.url+'/api/eng/water_cooler/get_record_by_date/'+date
    ...
    addRecord(formInputs): Promise<any> {
        ...
        let addUrl = this.url + '/api/eng/water_cooler/add_record';
        return new Promise((resolve, reject) => {
    ...
    updateRecord(formInputs) {
        let updateUrl = this.url + '/api/eng/water_cooler/update_record';
        return new Promise((resolve, reject) => {
    ...
    deleteRecord(id):Promise<any>{
        let deleteUrl=this.url+'/api/eng/water_cooler/delete_record/'+id;
        return new Promise((resolve,reject)=>{
