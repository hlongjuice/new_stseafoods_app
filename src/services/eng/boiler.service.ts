...
export class EngBoilerService {
    ...
    getRecordByDate(date) {
        let getUrl = this.url + '/api/eng/boiler/get_record_by_date/' + date
    ...
    //Add New Supply
    addGlobalDetails(formInputs): Promise<any> {
        console.log(formInputs)
        let addUrl = this.url + '/api/eng/boiler/add_global_details';
        return new Promise((resolve, reject) => {
    ...
    addRecord(formInputs): Promise<any> {
        console.log(formInputs)
        let addUrl = this.url + '/api/eng/boiler/add_record';
        return new Promise((resolve, reject) => {
            this.http.post(addUrl, formInputs, { headers: this.headers })
                .subscribe(
                result => { resolve(result.json()) },
    ...
    updateRecord(formInputs) {
        let updateUrl = this.url + '/api/eng/boiler/update_record';
        return new Promise((resolve, reject) => {
    ...
    deleteRecord(id): Promise<any> {
        let deleteUrl = this.url + '/api/eng/boiler/delete_record/' + id;
        return new Promise((resolve, reject) => {
