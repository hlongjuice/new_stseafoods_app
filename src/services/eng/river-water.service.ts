...
@Injectable()
export class EngRiverWaterService {
    ...
    getRecordByDate(date){
        let getUrl=this.url+'/api/eng/river_water/get_record_by_date/'+date
    ...
    addRecord(formInputs): Promise<any> {
        ...
        let addUrl = this.url + '/api/eng/river_water/add_record';
        return new Promise((resolve, reject) => {
    ...
    updateRecord(formInputs) {
        let updateUrl = this.url + '/api/eng/river_water/update_record';
        return new Promise((resolve, reject) => {
    ...
    deleteRecord(id):Promise<any>{
        let deleteUrl=this.url+'/api/eng/river_water/delete_record/'+id;
        return new Promise((resolve,reject)=>{
