...
@Injectable()
export class EngTank210Service {
    ...
    getRecordByDate(date){
        let getUrl=this.url+'/api/eng/tank_210/get_record_by_date/'+date
    ...
    addRecord(formInputs): Promise<any> {
        ...
        let addUrl = this.url + '/api/eng/tank_210/add_record';
        return new Promise((resolve, reject) => {
    ...
    updateRecord(formInputs) {
        let updateUrl = this.url + '/api/eng/tank_210/update_record';
        return new Promise((resolve, reject) => {
    ...
    deleteRecord(id):Promise<any>{
        let deleteUrl=this.url+'/api/eng/tank_210/delete_record/'+id;
        return new Promise((resolve,reject)=>{
