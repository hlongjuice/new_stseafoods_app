...
/**
 * Generated class for the EngCondensEditPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-eng-condens-edit',
  templateUrl: 'eng-condens-edit.html',
})
export class EngCondensEditPage {
  ...
  updateRecord(formInputs) {
    ...
    this.showLoader()
    this.engCondensService.updateRecord(formInputs)
      .then(result => {
