...
/**
 * Generated class for the EngWaterMeterEditPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-eng-water-meter-edit',
  templateUrl: 'eng-water-meter-edit.html',
})
export class EngWaterMeterEditPage {
  _loader: any
  _toast: any
  _alert: any
  ...
  updateRecord(formInputs) {
    ...
    this.showLoader()
    this.engWaterMeterService.updateRecord(formInputs)
      .then(result => {
