...
/**
 * Generated class for the EngWaterMeterAddPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-eng-water-meter-add',
  templateUrl: 'eng-water-meter-add.html',
})
export class EngWaterMeterAddPage {
  ...
  addRecord(formInputs,data) {
    ...
    let loader=this.loaderCtrl.create({content:'กำลังโหลดข้อมูล...'})
    loader.present();
    this.engWaterMeterService.addRecord(formInputs)
      .then(result => {
