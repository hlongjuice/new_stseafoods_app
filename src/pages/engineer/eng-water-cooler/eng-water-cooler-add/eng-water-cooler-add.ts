...
/**
 * Generated class for the EngWaterCoolerAddPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-eng-water-cooler-add',
  templateUrl: 'eng-water-cooler-add.html',
})
export class EngWaterCoolerAddPage {
  ...
  addRecord(formInputs,data) {
    ...
    let loader=this.loaderCtrl.create({content:'กำลังโหลดข้อมูล...'})
    loader.present();
    this.engWaterCoolerService.addRecord(formInputs)
      .then(result => {
