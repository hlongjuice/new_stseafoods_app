...
/**
 * Generated class for the EngWaterCoolerEditPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-eng-water-cooler-edit',
  templateUrl: 'eng-water-cooler-edit.html',
})
export class EngWaterCoolerEditPage {
  ...
  updateRecord(formInputs) {
    ...
    this.showLoader()
    this.engWaterCoolerService.updateRecord(formInputs)
      .then(result => {
