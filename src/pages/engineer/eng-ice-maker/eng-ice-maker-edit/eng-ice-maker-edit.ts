...
/**
 * Generated class for the EngIceMakerEditPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-eng-ice-maker-edit',
  templateUrl: 'eng-ice-maker-edit.html',
})
export class EngIceMakerEditPage {
  ...
  updateRecord(formInputs) {
    ...
    this.showLoader()
    this.engIceMakerService.updateRecord(formInputs)
      .then(result => {
