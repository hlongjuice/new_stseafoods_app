...
/**
 * Generated class for the EngIceMakerAddPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-eng-ice-maker-add',
  templateUrl: 'eng-ice-maker-add.html',
})
export class EngIceMakerAddPage {
  ...
  addRecord(formInputs,data) {
    ...
    let loader=this.loaderCtrl.create({content:'กำลังโหลดข้อมูล...'})
    this.engIceMakerService.addRecord(formInputs)
      .then(result => {
