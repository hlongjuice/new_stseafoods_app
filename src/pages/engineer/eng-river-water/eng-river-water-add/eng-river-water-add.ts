...
/**
 * Generated class for the EngRiverWaterAddPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-eng-river-water-add',
  templateUrl: 'eng-river-water-add.html',
})
export class EngRiverWaterAddPage {
  ...
  addRecord(formInputs,data) {
    ...
    let loader=this.loaderCtrl.create({content:'กำลังโหลดข้อมูล...'})
    loader.present();
    this.engRiverWaterService.addRecord(formInputs)
      .then(result => {
