...
/**
 * Generated class for the EngHighTankEditPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-eng-high-tank-edit',
  templateUrl: 'eng-high-tank-edit.html',
})
export class EngHighTankEditPage {
  ...
  updateRecord(formInputs) {
    ...
    this.showLoader()
    this.engHighTankService.updateRecord(formInputs)
      .then(result => {
