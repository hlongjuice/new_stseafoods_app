...
/**
 * Generated class for the CarAccessUsageEditPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-car-access-usage-edit',
  templateUrl: 'car-access-usage-edit.html',
})
export class CarAccessUsageEditPage {
